...
const Dashboard: React.FC = () => {
    ...
    // Optimize filtering: only re-calculate when reports or search term changes
    ...
    // Statistics
    // Optimize stats calculation: only re-calculate when reports list changes,
    // preventing expensive re-loops on every render (e.g. typing in search)
    const stats = useMemo(() => {
